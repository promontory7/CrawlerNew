...
public class Project {
    ...
    public String toString() {
        return "Project{" +
                ...
                ", ownerpeoplePhone='" + ownerpeoplePhone + '\'' +
                ", agency='" + agency + '\'' +
                ", agencyName='" + agencyName + '\'' +
                ", agecyPhone='" + agecyPhone + '\'' +
                ", bond='" + bond + '\'' +
                ", bonder='" + bonder + '\'' +
                ", isAcceptUnion='" + isAcceptUnion + '\'' +
                ", qualification_requir='" + qualification_requir + '\'' +
                ", manager_require='" + manager_require + '\'' +
                ", attach='" + attach + '\'' +
                ", article='" + article + '\'' +
                ", rawHtml='" + rawHtml + '\'' +
                ", state=" + state +
